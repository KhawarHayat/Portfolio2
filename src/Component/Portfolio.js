...
class Portfolio extends Component {
    render() {
        return (
            ...
            <ProjectBox src='Portfolio.jpg' projectName='Portfolio 2.0' list={['React', 'CSS3', 'JavaScript']} codeLink='https://github.com/KhawarHayat/Portfolio' siteLink='https://github.com/KhawarHayat/Portfolio' />
